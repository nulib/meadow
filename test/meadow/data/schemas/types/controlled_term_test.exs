defmodule Meadow.Data.Types.ControlledTermTest do
  ...
  describe "FetchControlledTermLabel.gql" do
    ...
    test "cast function" do
      assert {:ok, @controlled_term.id} == ControlledTerm.cast(@controlled_term)
      assert {:ok, @controlled_term.id} == ControlledTerm.cast(@controlled_term.id)
    ...
    test "dump function" do
      {:ok, id} = ControlledTerm.cast(@controlled_term)
      assert ControlledTerm.dump(id) == {:ok, id}
