defmodule Meadow.Config.Runtime do
  ...
  def configure! do
    ...
    config :meadow, WalEx,
      ...
      subscriptions: [
        "works",
        "work_descriptive_metadata",
        "work_administrative_metadata",
        "work_metadata_values",
        "work_controlled_entries",
        "work_notes",
        "work_related_urls",
        "work_dates_created",
        "work_nav_places",
        "file_sets",
        "file_set_core_metadata",
        "file_set_structural_metadata",
        "file_set_derivatives",
        "file_set_extracted_metadata",
    ...
    config :meadow, Meadow.Search.Cluster,
      ...
      bulk_page_size: 50,
      bulk_request_limit: 1024 * 1024 * 10,
