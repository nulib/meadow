defmodule Meadow.Indexing.V1.WorkDescriptiveMetadata do
  @moduledoc """
  v1 encoding for WorkDescriptiveMetadata
  """
    ...
    %{
      descriptiveMetadata:
        ...
        |> Enum.map(fn field_name ->
          {Inflex.camelize(field_name, :lower) |> String.to_atom(),
           encode_field(Map.get(md, field_name))}
        end)
        |> Enum.into(%{})
    }
  end
