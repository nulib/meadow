defmodule Meadow.Indexing.V1.Work do
  @moduledoc """
  v1 encoding for Works
  """

  alias Meadow.Data.FileSets
  alias Meadow.IIIF
  alias Meadow.Indexing.V1
  ...
  def encode(work) do
    ...
    |> Map.merge(V1.WorkAdministrativeMetadata.encode(work.administrative_metadata))
    |> Map.merge(V1.WorkDescriptiveMetadata.encode(work.descriptive_metadata))
