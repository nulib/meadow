...
export type BatchAddDescriptiveMetadataInput = {
  ...
  physicalDescriptionMaterial?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  physicalDescriptionSize?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
...
export type ChatMessage = {
  ...
  /** Ref for the conversation */
  conversationId?: Maybe<Scalars['ID']['output']>;
  /** The prompt associated with the message */
  prompt?: Maybe<Scalars['String']['output']>;
  /** The search query associated with the message */
  query?: Maybe<Scalars['String']['output']>;
  /** Type of message, e.g. 'chat' */
...
export type ChatResponse = {
  ...
  /** The ID of the plan created for this chat message */
  planId?: Maybe<Scalars['ID']['output']>;
  /** Type of message, e.g. 'chat', 'plan_id' */
  type?: Maybe<Scalars['String']['output']>;
};
...
/** Fields for a `plan_change` object */
export type PlanChange = {
  __typename?: 'PlanChange';
  add?: Maybe<Scalars['Json']['output']>;
  completedAt?: Maybe<Scalars['DateTime']['output']>;
  ...
  notes?: Maybe<Scalars['String']['output']>;
  planId?: Maybe<Scalars['ID']['output']>;
  replace?: Maybe<Scalars['Json']['output']>;
  status?: Maybe<PlanStatus>;
  updatedAt?: Maybe<Scalars['DateTime']['output']>;
  user?: Maybe<Scalars['String']['output']>;
...
export type PlanChangeUpdate = {
  __typename?: 'PlanChangeUpdate';
  /** The action that occurred: 'created', 'updated', 'deleted' */
  action: Scalars['String']['output'];
  /** The updated plan change */
  planChange?: Maybe<PlanChange>;
  /** The plan ID */
...
export type RootMutationType = {
  ...
  /** Apply an approved plan to works */
  applyPlan?: Maybe<Plan>;
  /** Assume role */
  ...
  /** Publish a chat response to subscribed clients (for internal use by agents) */
  publishChatResponse?: Maybe<ChatResponse>;
  ...
  /** Update plan change content (add, replace, delete) */
  updatePlanChange?: Maybe<PlanChange>;
  /** Update plan change status (approve or reject) */
  updatePlanChangeStatus?: Maybe<PlanChange>;
  /** Update plan status (approve or reject) */
  updatePlanStatus?: Maybe<Plan>;
  /** Update an Ingest Project */
  updateProject?: Maybe<Project>;
  /** Update all proposed plan change statuses (approve or reject) */
  updateProposedPlanChangeStatuses?: Maybe<Array<Maybe<PlanChange>>>;
  /** Update a Work */
...
export type RootMutationTypeApplyPlanArgs = {
  id: Scalars['ID']['input'];
};
...
export type RootMutationTypePublishChatResponseArgs = {
...
export type RootMutationTypeSendChatMessageArgs = {
  conversationId: Scalars['ID']['input'];
...
export type RootMutationTypeUpdatePlanChangeArgs = {
  add?: InputMaybe<Scalars['Json']['input']>;
  delete?: InputMaybe<Scalars['Json']['input']>;
  id: Scalars['ID']['input'];
  replace?: InputMaybe<Scalars['Json']['input']>;
};


export type RootMutationTypeUpdatePlanChangeStatusArgs = {
  id: Scalars['ID']['input'];
...
export type RootMutationTypeUpdatePlanStatusArgs = {
  id: Scalars['ID']['input'];
  notes?: InputMaybe<Scalars['String']['input']>;
  status: PlanStatus;
};
...
export type RootMutationTypeUpdateProposedPlanChangeStatusesArgs = {
  notes?: InputMaybe<Scalars['String']['input']>;
...
export type RootQueryType = {
  ...
  /** Get a plan by id */
  plan?: Maybe<Plan>;
  /** Get a plan change by id */
  planChange?: Maybe<PlanChange>;
  /** Get all changes for a plan */
  planChanges?: Maybe<Array<Maybe<PlanChange>>>;
...
export type RootQueryTypePlanChangeArgs = {
  id: Scalars['ID']['input'];
};


export type RootQueryTypePlanChangesArgs = {
  planId: Scalars['ID']['input'];
};
...
export type RootSubscriptionType = {
  ...
  chatResponse?: Maybe<ChatResponse>;
  ...
  planChangesUpdated?: Maybe<PlanChangeUpdate>;
...
export type RootSubscriptionTypeChatResponseArgs = {
  conversationId: Scalars['ID']['input'];
};
...
export type RootSubscriptionTypePlanChangesUpdatedArgs = {
  planId: Scalars['ID']['input'];
};


export type RootSubscriptionTypePlanUpdatedArgs = {
  planId: Scalars['ID']['input'];
};
...
export type WorkDescriptiveMetadata = {
  ...
  physicalDescriptionMaterial?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
