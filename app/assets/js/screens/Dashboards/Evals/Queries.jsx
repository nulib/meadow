...
export default function EvalsQueriesScreen() {
  ...
  const [createQuery] = useMutation(CREATE_EVAL_QUERY, {
    refetchQueries: [{ query: GET_EVAL_QUERY_LIST }],
  });
  const [updateQuery] = useMutation(UPDATE_EVAL_QUERY, {
    refetchQueries: [{ query: GET_EVAL_QUERY_LIST }],
  });
  const [deleteQuery] = useMutation(DELETE_EVAL_QUERY, {
    refetchQueries: [{ query: GET_EVAL_QUERY_LIST }],
  });
  ...
  const startEdit = (q) => {
    ...
    setForm({
      ...
      queryJson: JSON.stringify(q.queryJson, null, 2),
    });
    setShowNew(false);
  };
    ...
    <div className="box">
      ...
      <div className="field">
        ...
        <textarea
          ...
          onChange={(e) => {
            setForm({ ...form, queryJson: e.target.value });
        ...
        <div className="container">
          <Breadcrumbs
            items={[
              ...
              },
              {
                ...
                route: "/dashboards/evals/queries",
                isActive: true,
              },
            ]}
          />
          <div className="level">
            <div className="level-left">
              <h1 className="title">Eval Queries</h1>
            </div>
              ...
              {editing?.id === q.id ? (
                ...
                <div className="box is-flex is-justify-content-space-between is-align-items-center">
                  <div>
                    ...
                    {q.description && (
                      <p className="is-size-7 has-text-grey">{q.description}</p>
                    )}
