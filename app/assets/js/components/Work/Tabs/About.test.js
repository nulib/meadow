...
describe("Work About tab component", () => {
  ...
  it("does not render the deprecated work-level GeoNames navPlace editor", async () => {
    await screen.findByTestId("work-about-form");
    expect(screen.queryByTestId("geonames-nav-place")).not.toBeInTheDocument();
  });
});
