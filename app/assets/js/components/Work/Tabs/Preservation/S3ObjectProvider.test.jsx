...
const mocks = [
  {
          ...
          objects: [
            {
              ...
              lastModified: "2024-09-14T05:12:59.224Z",
            },
            {
    ...
    expected: {
      files: [
        {
          id: "s3://bucket/file1.jpg",
          name: "file1.jpg",
          size: 1000,
          modDate: "2024-09-14T05:12:59.224Z",
          isDir: false,
          icon: "image",
        },
        {
          id: "s3://bucket/file2.png",
          name: "file2.png",
          size: 2000,
          modDate: "2024-09-14T05:12:59.224Z",
          isDir: false,
  ...
  },
  {
      ...
      data: {
        listIngestBucketObjects: {
          objects: [
            ...
            {
              uri: "s3://bucket/file_sets/file4.png",
              key: "file_sets/file4.png",
              size: 2000,
              mimeType: "image/png",
              storageClass: "STANDARD",
              lastModified: "2024-09-14T05:12:59.224Z",
    ...
    expected: {
      files: [
        {
          id: "s3://bucket/file_sets/file3.jpg",
          name: "file3.jpg",
          size: 1000,
          modDate: "2024-09-14T05:12:59.224Z",
          isDir: false,
        ...
        {
          id: "s3://bucket/file_sets/file4.png",
          name: "file4.png",
          size: 2000,
          modDate: "2024-09-14T05:12:59.224Z",
          isDir: false,
      ...
      folders: [
        { id: "/", name: "ingest", isDir: true, icon: "" },
        { id: "file_sets", name: "file_sets", isDir: true, icon: "" },
      ],
    },
  },
];
