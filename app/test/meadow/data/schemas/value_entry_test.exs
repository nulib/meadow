defmodule Meadow.Data.Schemas.ValueEntryTest do
  ...
  describe "direct-jsonb normalization" do
    test "rejects duplicate ids within a field" do
      assert_raise ArgumentError, ~r/duplicate item id/, fn ->
    ...
    test "rejects an invalid supplied id" do
      assert_raise ArgumentError, ~r/invalid item id/, fn ->
        WorkDescriptiveMetadata.jsonb_value_entries(%{
          description: [%{id: "not-a-uuid", value: "Bad"}]
        })
      end
    end
  end
