%{
  administrative_metadata: %{
    ...
    preservation_level: %{id: "2", scheme: "preservation_level"},
  ...
  descriptive_metadata: %{
    ...
    creator: [
      ...
      %{term: %{id: "http://vocab.getty.edu/ulan/500445403"}},
    ...
    style_period: [
      ...
      %{term: %{id: "http://vocab.getty.edu/aat/300375743"}}
    ],
    technique: [
      %{term: %{id: "http://vocab.getty.edu/aat/300438611"}},
      %{term: %{id: "http://vocab.getty.edu/aat/300400619"}},
    ...
    language: [
      %{term: %{id: "http://id.loc.gov/vocabulary/languages/bug"}},
      %{term: %{id: "http://id.loc.gov/vocabulary/languages/nia"}},
    ...
    genre: [%{term: %{id: "http://vocab.getty.edu/aat/300185712"}}],
    box_number: ["1"],
    subject: [
      %{
