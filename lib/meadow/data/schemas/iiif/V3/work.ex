...
defimpl Meadow.IIIF.V3.Resource, for: Meadow.Data.Schemas.Work do
      ...
      %Canvas{
        ...
        items: [
          %AnnotationPage{
            ...
            items: access_file_media_annotations(work, file_set)
          }
        ],
        annotations: access_file_vtt_annotation_page(work, file_set)
      }
    end)
  end
  ...
  defp access_file_media_annotations(work, file_set) do
    [
      %Annotation{
        id: IIIF.V3.annotation_id(work.id, file_set.id, "1", "1"),
        body: %Content{
  ...
  defp access_file_vtt_annotation_page(
         work,
         %{structural_metadata: %{type: "webvtt", value: _value}} = file_set
       ) do
    [
      %AnnotationPage{
        id: IIIF.V3.annotation_page_id(work.id, file_set.id, "a1"),
        items: [
          %Annotation{
  ...
  defp access_file_vtt_annotation_page(_work, _file_set), do: []
