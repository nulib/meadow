defmodule Meadow.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule MeadowWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Meadow.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: MeadowWeb.Router, endpoint: MeadowWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:meadow, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
