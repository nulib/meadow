...
(`on_delete: :nilify_all`). The existing human-readable AI disclosure notes are
retained alongside provenance: metadata apply, planner plan changes, and
transcription each still write their free-text "created with the assistance of
AI" / "Transcription generated by AI" note in addition to recording canonical
provenance.
...
dependency they did not have before. Canonical records are the source of truth;
